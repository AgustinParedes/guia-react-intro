//8- Escribir un programa en React que agregue y quite nombres del listado generado en el programa
//anterior. Emplear un formulario para ingresar un nuevo nombre.
